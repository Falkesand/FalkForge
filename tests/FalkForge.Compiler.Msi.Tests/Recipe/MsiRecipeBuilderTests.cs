...
public sealed class MsiRecipeBuilderTests
{
    ...
    {
        // Phase 4 wires in thirty-two built-in producers (Property,
        ...
        // TypeLib, MsiAssembly, Verb, MoveFile, RemoveFile). With an empty
        ...
        // recipe's Tables array therefore contains thirty-two tables, not zero.
        ...
        Assert.Equal(32, recipe.Tables.Length);
