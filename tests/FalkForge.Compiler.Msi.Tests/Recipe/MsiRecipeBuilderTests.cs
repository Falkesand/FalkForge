...
public sealed class MsiRecipeBuilderTests
{
    ...
    {
        // Phase 4 wires in thirty built-in producers (Property,
        ...
        // Verb, MoveFile, RemoveFile). With an empty resolved package each
        // producer emits zero rows but the table itself is still present so
        // downstream phases see a stable table set. The recipe's Tables array
        // therefore contains thirty tables, not zero.
        ...
        Assert.Equal(30, recipe.Tables.Length);
