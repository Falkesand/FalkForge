...
public sealed class MsiRecipeBuilderTests
{
    ...
    {
        // Phase 4 wires in twenty-three built-in producers (Property,
        ...
        // IniFile, CreateFolder, DuplicateFile, CustomAction, MoveFile,
        ...
        // contains twenty-three tables, not zero.
        ...
        Assert.Equal(23, recipe.Tables.Length);
