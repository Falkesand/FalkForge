...
public sealed class MsiRecipeBuilderTests
{
    ...
    {
        // Phase 4 wires in thirty-one built-in producers (Property,
        ...
        // TypeLib, Verb, MoveFile, RemoveFile). With an empty resolved package
        ...
        // array therefore contains thirty-one tables, not zero.
        ...
        Assert.Equal(31, recipe.Tables.Length);
