...
{
    [Fact]
    public void Build_with_simple_resolved_package_emits_nineteen_tables_in_order()
    {
        ...
        Assert.Equal(19, result.Value.Tables.Length);
    }
    ...
    public void Build_table_order_is_fk_safe_topological()
    {
        ...
        Assert.Equal("MoveFile", recipe.Tables[17].Name.Value);
        Assert.Equal("RemoveFile", recipe.Tables[18].Name.Value);
    }
