...
**0.5.0-beta.5.** The core compiler and engine are exercised
...
[release notes](https://github.com/Falkesand/FalkForge/blob/main/docs/release-notes/v0.5.0-beta.5.md)
