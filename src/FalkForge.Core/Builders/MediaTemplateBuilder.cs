...
public sealed class MediaTemplateBuilder
{
    ...
    private FalkForge.CompressionLevel _compressionLevel = FalkForge.CompressionLevel.High;
    ...
    public MediaTemplateBuilder CompressionLevel(FalkForge.CompressionLevel level)
    {
