...
/// mirroring <c>FirewallCommandFactory.MakeStepId</c>. The identifier keys the generated deferred
/// custom actions (and their <c>_rb</c>/<c>_un</c> variants), so it must satisfy the MSI identifier
/// grammar (<c>^[A-Za-z_][A-Za-z0-9_]*$</c>) and stay well under the <c>CustomAction.Action</c>
/// CHAR(72) budget once the longest suffix is appended.
/// </summary>
internal static class UtilStepId
{
