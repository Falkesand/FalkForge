...
namespace FalkInstaller.Decompiler;

/// <summary>
/// Converts a <see cref="PackageModel"/> into fluent C# source code
/// that recreates the installer definition using the FalkInstaller builder API.
/// </summary>
public sealed class CSharpEmitter
{
    ...
    public string Emit(PackageModel package)
    {
        ...
        AppendLine("using FalkInstaller;");
        AppendLine("using FalkInstaller.Builders;");
        AppendLine("using FalkInstaller.Models;");
        AppendLine();
